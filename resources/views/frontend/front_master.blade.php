...
<head>
    ...
    <!-- css file -->
    @include('user_interface.partials.styles')

    <!-- Title -->
 <title>@yield('title', 'Homez - Real Estate')</title>
    <!-- Favicon -->
    <link href="{{ asset('frontend/assets/images/favicon.ico') }}" sizes="128x128" rel="shortcut icon" type="image/x-icon" />
    <link href="{{ asset('frontend/assets/images/favicon.ico') }}" sizes="128x128" rel="shortcut icon" />
    <!-- Apple Touch Icon -->
    <link href="{{ asset('frontend/assets/images/apple-touch-icon-60x60.png') }}" sizes="60x60" rel="apple-touch-icon">
    <link href="{{ asset('frontend/assets/images/apple-touch-icon-72x72.png') }}" sizes="72x72" rel="apple-touch-icon">
    <link href="{{ asset('frontend/assets/images/apple-touch-icon-114x114.png') }}" sizes="114x114" rel="apple-touch-icon">
    <link href="{{ asset('frontend/assets/images/apple-touch-icon-180x180.png') }}" sizes="180x180" rel="apple-touch-icon">
      ...
      <div class="header innerpage-style">
        <div class="menu_and_widgets">
          <div class="mobile_menu_bar d-flex justify-content-between align-items-center">
            <a class="menubar" href="#menu"><img src="{{ asset('frontend/assets/images/mobile-dark-nav-icon.svg') }}" alt=""></a>
            <a class="mobile_logo" href="#"><img src="{{ asset('frontend/assets/images/k.png') }}" alt=""></a>
     ...
     @yield('content')
          ...
          @include('user_interface.body.footer')
            <a class="scrollToHome" href="#"><i class="fas fa-angle-up"></i></a>
               ...
               @include('user_interface.partials.scripts')
