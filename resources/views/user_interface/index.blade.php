      ...
      <div class="home-style1">
        ...
        <a href="#explore-property">
          <div class="mouse_scroll animate-up-4">
            <img src="{{ asset('frontend/assets/images/about/home-scroll.png') }}" alt="">
          </div>
        </a>
      </div>
    </section>
            ...
            <div class="property-city-slider dots_none slider-dib-sm slider-4-grid2 vam_nav_style owl-theme owl-carousel">
              <div class="item">
                <div class="feature-style1 mb30">
                  <div class="feature-img"><img class="w-100" src="{{ asset('frontend/assets/images/listings/city-listing-1.png') }}" alt=""></div>
              ...
              <div class="item">
                <div class="feature-style1 mb30">
                  <div class="feature-img"><img class="w-100" src="{{ asset('frontend/assets/images/listings/city-listing-2.png') }}" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
              ...
              <div class="item">
                <div class="feature-style1 mb30">
                  <div class="feature-img"><img class="w-100" src="{{ asset('frontend/assets/images/listings/city-listing-3.png') }}" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
              ...
              <div class="item">
                <div class="feature-style1 mb30">
                  <div class="feature-img"><img class="w-100" src="{{ asset('frontend/assets/images/listings/city-listing-4.png') }}" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
            ...
            <div class="testimonial-slider navi_pagi_top_right slider-3-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
                ...
                <div class="testimonial-style1 position-relative">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="{{ asset('frontend/assets/images/testimonials/testimonial-1.png') }}" alt="">
                    </div>
              ...
              <div class="item">
                <div class="testimonial-style1 position-relative">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="{{ asset('frontend/assets/images/testimonials/testimonial-2.png') }}" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
              ...
              <div class="item">
                <div class="testimonial-style1 position-relative">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="{{ asset('frontend/assets/images/testimonials/testimonial-3.png') }}" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
        ...
        <div class="row wow fadeInUp" data-wow-delay="300ms">
          <div class="col-sm-6 col-lg-4">
            <div class="blog-style1">
              <div class="blog-img"><img class="w-100" src="{{ asset('frontend/assets/images/blog/blog-1.jpg') }}" alt=""></div>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="blog-style1">
              <div class="blog-img"><img class="w-100" src="{{ asset('frontend/assets/images/blog/blog-2.jpg') }}" alt=""></div>
              <div class="blog-content">
                <div class="date">
                  <span class="month">July</span>
                  <span class="day">28</span>
          ...
          <div class="col-sm-6 col-lg-4">
            <div class="blog-style1">
              <div class="blog-img"><img class="w-100" src="{{ asset('frontend/assets/images/blog/blog-3.jpg') }}" alt=""></div>
              <div class="blog-content">
                <div class="date">
                  <span class="month">July</span>
                  <span class="day">28</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="dots_none nav_none slider-dib-sm slider-6-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/1.png') }}" alt="1.png"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/2.png') }}" alt="2.png"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/3.png') }}" alt="3.png"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/4.png') }}" alt="4.png"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/5.png') }}" alt="5.png"></div>
              </div>
              <div class="item">
                <div class="partner_item"><img class="wa m-auto" src="{{ asset('frontend/assets/images/partners/6.png') }}" alt="6.png"></div>
              </div>
            </div>
          </div>
        </div>
...
@push('styles')
<style>
/* center the scroll hint at the bottom of the hero */
.home-banner-style1 .mouse_scroll{
  position:absolute; bottom:24px; left:50%; transform:translateX(-50%);
}

/* optional: tighten spacing on the search row */
@media (min-width: 768px){
  .home-banner-style1 .row.g-3{ --bs-gutter-x: 1rem; }
}
</style>
@endpush
