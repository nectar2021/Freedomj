...
<section class="home-banner-style1">
  <div class="home-style1">
    <!-- full-bleed wrapper removes side gutters -->
    <div class="container-fluid px-0">
      <!-- inner container keeps content at a readable width -->
      <div class="container">
        <div class="row">
                ...
                <ul class="nav nav-tabs p-0 m-0" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
                      data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Buy</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab"
                      data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Rent</button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab"
                      data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Sold</button>
                  </li>
                </ul>
                      ...
                      <div class="row g-3 align-items-center">
                          ...
                          <div class="advance-search-field position-relative text-start">
                            <form action="#" method="get" class="form-search position-relative" accept-charset="utf-8">
                              <div class="box-search">
                                ...
                                <input class="form-control bgc-f7 bdrs12" type="text" name="search"
                        ...
                        <div class="col-md-4 col-lg-3">
                          <div class="d-flex align-items-center justify-content-start justify-content-md-center">
                            <button class="advance-search-btn" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                              <span class="flaticon-settings"></span> Advanced
                            </button>
                            <button class="advance-search-icon ud-btn btn-thm ms-4" type="button">
    ...
    <!-- scroll hint -->
    {{-- <a href="#explore-property" class="mouse_scroll animate-up-4">
      <img src="{{ asset('frontend/assets/images/about/home-scroll.png') }}" alt="Scroll down">
    </a> --}}
  </div>
</section>
